...
func init() {
	proto.RegisterType((*ScriptsQuery)(nil), "coach.ScriptsQuery")
	proto.RegisterType((*GetScriptsResponse)(nil), "coach.GetScriptsResponse")
	proto.RegisterType((*RunEventIn)(nil), "coach.RunEventIn")
	proto.RegisterType((*RunEventOut)(nil), "coach.RunEventOut")
	proto.RegisterType((*EnvVar)(nil), "coach.EnvVar")
	proto.RegisterType((*SaveScriptRequest)(nil), "coach.SaveScriptRequest")
	proto.RegisterType((*Response)(nil), "coach.Response")
}
...
func (c *coachRPCClient) QueryScripts(ctx context.Context, in *ScriptsQuery, opts ...grpc.CallOption) (*GetScriptsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/coach.CoachRPC/QueryScripts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coachRPCClient) GetScript(ctx context.Context, in *ScriptsQuery, opts ...grpc.CallOption) (*DocumentedScript, error) {
	...
	err := c.cc.Invoke(ctx, "/coach.CoachRPC/GetScript", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coachRPCClient) RunScript(ctx context.Context, opts ...grpc.CallOption) (CoachRPC_RunScriptClient, error) {
	stream, err := c.cc.NewStream(ctx, &_CoachRPC_serviceDesc.Streams[0], "/coach.CoachRPC/RunScript", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *coachRPCClient) SaveScript(ctx context.Context, in *SaveScriptRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/coach.CoachRPC/SaveScript", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CoachRPC_QueryScripts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/coach.CoachRPC/QueryScripts",
	}
...
func _CoachRPC_GetScript_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/coach.CoachRPC/GetScript",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var fileDescriptor_a0b84a42fa06f626 = []byte{
	...
	,
}
